...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var feedSlider = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_1__["default"]({
    container: '.feed__slider_wrapper',
  ...
  new _modules_playVideo__WEBPACK_IMPORTED_MODULE_2__["default"]('.module__video .play', '.overlay').init();
...
/*#__PURE__*/
function () {
  function Defference(oldOfficer, newOfficer, items) {
    _classCallCheck(this, Defference);
  ...
  _createClass(Defference, [{
    ...
    key: "hideItems",
    value: function hideItems(card) {
      card.forEach(function (item, i, arr) {
        if (i !== arr.length - 1) {
...
function () {
  ...
  _createClass(Download, [{
    ...
    value: function downloadItem(path) {
      ...
      link.setAttribute('download', 'my_name');
  ...
  _createClass(ShowInfo, [{
    ...
    value: function init() {
      this.trigger.forEach(function (btn) {
        btn.addEventListener('click', function () {
          var block = btn.closest('.module__info-show').nextElementSibling;
